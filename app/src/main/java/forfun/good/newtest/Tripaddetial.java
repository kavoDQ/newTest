...
import forfun.good.newtest.tripdata.tripadd_constructor;

public class Tripaddetial extends AppCompatActivity {
        TextView tv1 ; //時間
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tripaddetial);
